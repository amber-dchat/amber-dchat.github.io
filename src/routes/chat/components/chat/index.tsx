  ...
  return (
    <div className="flex flex-col h-full w-full py-2">
      ...
      <form
        ...
        onSubmit={(ev) => {
          ev.preventDefault();
          const val = ev.currentTarget.querySelector<HTMLTextAreaElement>("textarea")?.value as string;
        ...
        <Textarea
          ...
          onKeyDown={(e) => {
            if (e.key == 'Enter' && !e.shiftKey) {
              e.preventDefault();
              document.querySelector<HTMLButtonElement>("#ahqsoft_submit_btn")?.click();
            }
          }}
          disabled={!room}
        />
