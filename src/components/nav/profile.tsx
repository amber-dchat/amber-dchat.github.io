...
export function EditProfile({
  ...
  return (
    <ResponsiveDialog open={open} setOpen={setOpen} title="Edit Your Profile" description="A reload is required to observe the changes">
            ...
            <CardContent className='space-y-2'>
              <form
                ...
                onSubmit={(e) => {
                  ...
                  const IdisplayName = document.querySelector<HTMLInputElement>("#displayName")?.value as string;
                  const IBio = document.querySelector<HTMLTextAreaElement>("#bio")?.value as string;
              ...
              >
                ...
                <div className='w-full'>
                  ...
                  <Textarea id='bio' placeholder='Describe about yourself' defaultValue={bio} maxLength={2048} minLength={20} className='resize-none h-40' required />
                </div>

                <Button type="submit" variant={"default"} className='text-lg flex space-x-1 justify-center text-center items-center'>
                  <Check />
                  Submit
                </Button>
              </form>
